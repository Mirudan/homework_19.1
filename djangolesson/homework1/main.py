    ...
    <div class="container">
        ...
        <div class="card">
            <header>
                <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                    ...
                    <p class="fs-5 text-body-secondary">Часто задаваемые вопросы</p>
                </div>
            </header>
            <div class="card">
                <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapseSale" aria-expanded="false" aria-controls="collapseExample">
                    Как купить?
                </button>
            ...
            <div class="card">
                <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapseDelivery" aria-expanded="false" aria-controls="collapseExample">
                    Как доставить?
                </button>
                <div class="collapse" id="collapseDelivery">
                    <div class="card card-body">
                        Оплатил, указал адрес, выбрал дату и время, а мы все привезли, возможно даже вовремя :)
                    </div>
                </div>
            </div>
            <div class="card">
                <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapseWarranty" aria-expanded="false" aria-controls="collapseExample">
                    Какая гарантия?
                </button>
                <div class="collapse" id="collapseWarranty">
                    <div class="card card-body">
                        Никаких гарантий, что поделать... Но есть гарантия от производителя, указана в карточке товара
                        :)
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <table class="table">
                ...
                <tr>
                    <th scope="row">4</th>
                    <td>Игровая видеокарта RTX5090</td>
                    <td>300000</td>
                    <td>1</td>
                    <td>300000</td>
